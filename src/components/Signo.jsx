...
export default function Signo({ startDate }) {
  ...
  return (
    <section className="h-screen flex items-center justify-center relative overflow-hidden snap-start px-4 bg-[#121212] shadow-[inset_0_0_150px_rgba(0,0,0,0.7)] select-none">
      {/* Fundo com estrelas */}
